...
export default function App_Form_Galk_Lab() {
  ...
  function function1(doc)
  {
	...
	//doc.addImage(signature, 'png', 50+margin,205,40,10,);

	doc.setFontSize(12);
	doc.setTextColor(0,0,0);
	doc.text(margin, 230, "Person in charge from Willings, Inc: ");
	doc.line(margin,230,71,230)
	...
	<div>
		...
		<Region>
			...
			<table>
				...
				<tr>
					<td><label htmlFor="nostudents">Number of Students Hired</label></td>
				...
				<tr>
					...
					<td><input type="file" id="signature" value={signature} onChange={(e) => 
						setsign(e.target.value)} /></td>
				</tr>
