...
import StudentDetailsDialog from "../allStudents/common/studentDetailsDialog";
...
const TagEngineers = ({
	...
	// 	tagAndAssignEngineerInProject(selectedJob, studentId);
	// };
...
const mapStateToProps = (state) => ({
	...
	jobAssignProcessing: state.galkLabJobs.jobAssignProcessing,
