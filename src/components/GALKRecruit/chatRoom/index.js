...
import { getChatActiveStatus } from "../../../reducers/chatRoomSelector";
...
const ChatRoomContainer = ({
	...
	submitGroupChatMsg,
	loggedInUserEmail,
	loadedCompanyIdBySuperAdmn,
	isFileUploading,
	fileUploadProgress,
	companyAccountType,
}) => {
	const [showCreateIndividualChatModal, setShowCreateIndividualChatModal] =
		useState(false);
					...
					<Layout style={{ height: "100%", border: "1px solid #3977f5" }}>
						<Sider className="chatRoom_userList_container">
							...
							<UserList
								...
								isRestrictedAccountType={isRestrictedAccountType}
							/>
						</Sider>
						<Layout>
							<Header className="chatRoom_messageHeader-container">
								{selectedChatId && (
									<React.Fragment>
										<span className={isRestrictedAccountType ? "blur" : ""}>
											{t("your_conversation")}
...
const mapStateToProps = (state) => ({
	...
	loadedCompanyIdBySuperAdmn: state.superAdmin.selectedCompanyId,
