...
import { createInternshipJob, updateLoading } from "../../../actions/internshipJobPostingActions";
	...
	const createJob = (formValues) => {
		...
		database
			...
			.then(() => {
				...
				createInternshipJob(dataToUpdate);
			})
			.catch((ex) => {
...
export default connect(mapStateToProps, { createInternshipJob, updateLoading })(
	CreateJobModal
);
