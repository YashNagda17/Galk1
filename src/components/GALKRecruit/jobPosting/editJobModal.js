...
import { updateInternshipJob, updateLoading } from "../../../actions/internshipJobPostingActions";
...
export default connect(mapStateToProps, { updateInternshipJob, updateLoading })(EditJobModal);
